...
## AMP
You know AMP right? the thing that google created so that your page loads faster in mobile.
...
## Problem
Now the thing is our blog's content which is written by some content writer who is using ckeditor, will render perfectly in normal webpages.
